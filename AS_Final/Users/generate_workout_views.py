...
# if request.session["Level_Up"]:
	...
	if _Member.Level == 6:
		...
		context["Level_Up_Message_Body"] = Messages_Dict[11]
		context["Level_Up_Img_URL"] = Messages_Dict["11_Static"]
	elif _Member.Level == 16:
		context["Level_Up_Message_Body"] = Messages_Dict[16]
		context["Level_Up_Img_URL"] = Messages_Dict["16_Static"]
	...
	if request.GET.get("Get_Videos"):
		request.session["Filter_One_Level"] = True
